...
?seq()
# Answer: "Error in help.search("seq", fields = "seq", package = NULL) : incorrect field specification" it does not know what seq is. Perhaps, a library needs to be imported?
...
names(n)<-v
## It gives the numbers and the words we have alloted them to
