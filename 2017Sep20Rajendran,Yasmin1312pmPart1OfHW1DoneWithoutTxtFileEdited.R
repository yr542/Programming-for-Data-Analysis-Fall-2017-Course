...
#Answer: I believe I just did above, using the cbind command?


#Subsetting a matrix
## Classwork/Homework:1) What will M[5] print? Specify the rationale behind this.
M <- matrix(1:9,nrow=3)
M
M[5]
## Answer: M[5] will print the number in the fifth position in the matrix which we stored in the variable M in the case above it will print the number 5.
## Classwork/Homework:2) What does this subset print, M[c(2,3),c(1,2)]? 
M[c(2,3),c(1,2)]
## Answer:It will print according to this M[Rows, Columns] therefore, it will print the numbers in the second and third row and the 1st and 2nd column.


# Matrix arithmetic
## Classwork/Homework:1) What happens if you subtract/add/multiply two matrices of different size? 
Matx_1 <- matrix(1:6, nrow=6, byrow=TRUE)
Matx_1
Matx_2 <- matrix(1:12, nrow=6, byrow=TRUE)
Matx_2
Matx_2 - Matx_1
Matx_2 + Matx_1
Matx_2 * Matx_1
Matx_2 / Matx_1
##Answer : You cannot do this as it gets an error as they are "non-conformable arrays".
